  ...
  return (
    <div>
      ...
      <div style={{ width: "80%", marginTop: "50px" }}>
        ...
        >
          <Grid item xs={12} sm={6} md={6}>
            <CardMediaBox component="img" src={branch3} alt="Branche1" />
          </Grid>
          <Grid
            item
            xs={12}
        ...
        >
          <Grid item xs={12} sm={6} md={6}>
            <CardMediaBox component="img" src={branch4} alt="Branche1" />
          </Grid>
          <Grid
            item
            xs={12}
        ...
        >
          <Grid item xs={12} sm={6} md={6}>
            <CardMediaBox component="img" src={branch1} alt="Branche1" />
          </Grid>
          <Grid
            item
            xs={12}
