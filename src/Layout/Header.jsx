...
import { AppBar, Box, Button, CssBaseline, Divider, Drawer, IconButton, List, ListItem, ListItemButton, ListItemText, Toolbar, Typography, Grid } from '@mui/material';
    ...
    <AppBar component="nav" sx={{backgroundColor:"#ff5400"}}>
        <Toolbar sx={{width:"100%"}}>
          ...
          <Grid container sx={{display:"flex",justifyContent:"space-between", width:"100%", marginRight:"50px"}}>
            ...
            <Typography
            component="div"
            sx={{ flexGrow: 1, display: { xs: 'none', sm: 'block' } ,fontSize:"1.6rem", fontWeight:"600" }}
          >
            Foodino
          </Typography>
            </Grid>
          ...
          <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
            ...
            {navItems.map((item) => (
              <Button sx={{textTransform:"none",':hover':{color:'rgb(69, 68, 68)',bgcolor:"#ffffff52"}}}>
                <Link  to={`/${item}`} key={item} style={{color:"#fff", textDecoration:"none", fontSize:"1rem"}}>
                {item}
              </Link>
              </Button>
            ))}
